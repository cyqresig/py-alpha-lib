...
pub struct Context {
  ...
  #[cfg_attr(feature = "python", pyo3(attribute("start")))]
  pub _start: i32,
  /// only calculate up to this index, 0 means up to the last, -1 means up to the second last
  #[cfg_attr(feature = "python", pyo3(attribute("end")))]
  pub _end: i32,
  ...
  #[cfg_attr(feature = "python", pyo3(attribute("groups")))]
  pub _groups: u32,
  /// flags, indicates the calculation flags
  #[cfg_attr(feature = "python", pyo3(attribute("flags")))]
  pub _flags: u64,
}
