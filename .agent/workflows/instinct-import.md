...
implementation: python3 .agent/skills/continuous-learning-v2/scripts/instinct-cli.py import <file>
---
...
```bash
python3 .agent/skills/continuous-learning-v2/scripts/instinct-cli.py import <file-or-url> [--dry-run] [--force] [--min-confidence 0.7]
```
